...
import { LayoutDashboard, Users, ShoppingBag, Receipt, DollarSign, LogOut } from 'lucide-react';
    ...
    <aside className="w-80 bg-black border-r border-white/5 flex flex-col h-screen sticky top-0 z-20">
      ...
      <div className="p-8 space-y-4">
        <div className="p-6 bg-white/[0.02] border border-brand-gold/10 rounded-[2rem]">
          ...
          <p className="text-xs text-white font-display italic">Mesa de Operações</p>
          <p className="text-[10px] text-white/30 mt-1 lowercase">suporte.atacado@casalinda.com</p>
        </div>
