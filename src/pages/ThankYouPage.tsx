...
export const ThankYouPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-dark bg-noise text-white selection:bg-brand-gold selection:text-black font-sans relative flex items-center justify-center p-6">
      ...
      <div className="absolute bottom-0 left-[-200px] w-[500px] h-[500px] bg-white/[0.03] rounded-full blur-[120px] pointer-events-none animate-float-delayed"></div>
      ...
      <div className="max-w-2xl w-full text-center relative z-10 space-y-12">
        ...
        <div className="space-y-6">
          <h1 className="text-5xl md:text-6xl font-display text-white italic tracking-tight">Candidatura Recebida.</h1>
        ...
        <div className="glass-panel glass-edge p-10 rounded-[2rem] border border-brand-gold/20 shadow-[0_0_30px_rgba(197,160,89,0.05)] text-left">
          <div className="flex items-start gap-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">Aguardando Aprovação</h3>
